...
tparam <- function() {
  ...
  b1 <- pnorm(size, mean=93.919-3*6.515,sd=6.515) #correct selectivity for trawl
  b2 <- pnorm(size, mean=93.919-99*15,sd=15) 
  selectivity_t <- b1*b2
  Af_t <- selectivity_t
  ...
  #     main = "Length based selectivity for comm. trawl")
